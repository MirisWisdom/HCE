        ...
        public static Configuration GetFromStream(Stream stream)
        {
            ...
            var configuration = new Configuration
            {
                ...
                Audio =
                {
                    ...
                    Quality = (Quality) GetByte(reader, Configuration.AudioQualityOffset),
                    Variety = (Quality) GetByte(reader, Configuration.AudioVarietyOffset)
                },
                ...
                Video =
                {
                    ...
                    FrameRate = (FrameRate) GetByte(reader, Configuration.VideoFrameRateOffset),
                    ...
                    Particles = (Particles) GetByte(reader, Configuration.VideoParticlesOffset),
                    Quality = (Quality) GetByte(reader, Configuration.VideoQualityOffset)
                },

                Network =
                {
                    Connection = (Connection) GetByte(reader, Configuration.NetworkConnectionTypeOffset),
